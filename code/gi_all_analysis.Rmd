...
data2plot$feature = factor(data2plot$feature, levels = rev(c("face","touched","motion","watchability","human","social","nonsocial","text","taste","touch","emotion","gazed","operability","sound","smell","animal")))
