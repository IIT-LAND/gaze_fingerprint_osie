...
data2plot$feature = factor(data2plot$feature, levels = rev(c("operability","smell","taste","watchability","nonsocial","face","touch","human","social","text","touched","gazed","motion","emotion","animal","sound")))
