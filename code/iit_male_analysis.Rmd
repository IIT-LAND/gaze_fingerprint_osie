...
data2plot$feature = factor(data2plot$feature, levels = rev(c("text","taste","motion","watchability","face","touch","operability","nonsocial","touched","human","social","smell","gazed","animal","emotion","sound")))
