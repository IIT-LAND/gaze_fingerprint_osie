...
data2plot$feature = factor(data2plot$feature, levels = rev(c("text","taste","operability","watchability","touched","face","touch","human","social","nonsocial","motion","gazed","animal","smell","emotion","sound")))
